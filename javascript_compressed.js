...
Blockly.JavaScript.Event = function(a) {
	var start = "bp.Event(";
	var end = ")";
	var text = Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_NONE) || "false";
	return [start + text + end,Blockly.JavaScript.ORDER_ADDITION];
};

Blockly.JavaScript.bSync = function(a) {
	
	var sec = "bp.sync( {";
	var coma = ",";
	var request = "request:";
	var b = Blockly.JavaScript.valueToCode(a, "request=", Blockly.JavaScript.ORDER_NONE) || "false";
	var waitfor = "\n\t\twaitFor:";
	var c = Blockly.JavaScript.valueToCode(a, "wait-for=", Blockly.JavaScript.ORDER_NONE) || "false";
	
	var block = "\n\t\tblock:";
	var d = Blockly.JavaScript.valueToCode(a, "block=", Blockly.JavaScript.ORDER_NONE) || "false";
	var end = "} );\n";
	var body = "";
	if(b !== "false") {
		body += request + b;
...
Blockly.JavaScript.bThread = function(a) {
	
	var start = "bp.registerBThread( ";
	var name = Blockly.JavaScript.valueToCode(a, "bThread", Blockly.JavaScript.ORDER_NONE) || "\"\"";
	var sec = ", function(){\n";
	
	var body = Blockly.JavaScript.statementToCode(a, 'DO');
	
	
	var end = "} );\n";
	
	
	return start + name + sec + body + end;
};